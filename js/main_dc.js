        ...
        gridItem.innerHTML = `
            ...
            <div id="${modalId}" class="modal">
                <div class="ventana ventana2">
                    ...
                    <div class="cont-det">
                        <div class="titulo-det" id="detallesContainer" style=" background-color: #0078f0;">${hero.name}</div>
                        <div class="titulo-det2" id="detallesContainer">${hero.about}</div>
                        <a href="#cerrar" class="cerrar2"><b style="color: weith; font-size: 20px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Regresar</b></a>
                    </div>
                </div>
            </div>
        `;
